    ...
    return (
        <main className="flex min-h-screen items-center justify-center bg-white px-6 py-24 sm:py-32 lg:px-8">
            <div className="text-center">
                ...
                <h1 className="mt-4 text-3xl font-bold tracking-tight text-black sm:text-5xl">Page non trouvée</h1>
                <p className="mt-6 text-base leading-7 text-gray-600">Désolé, nous n'avons pas pu trouver la page que vous cherchez.</p>
